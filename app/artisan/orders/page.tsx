...
export default function ArtisanOrdersPage() {
  ...
  const handleUpdateStatus = async (orderId: number, currentStatus: string) => {
    const trackingNumber = prompt("กรุณากรอกหมายเลขพัสดุ (Tracking Number) เพื่อยืนยันการจัดส่ง:");
    ...
    <div className="min-h-screen bg-stone-50 pb-20">
      <div className="bg-white border-b border-brand-200 py-10 px-4 text-center">
        ...
        <p className="text-brand-950/60 text-xs mt-2 max-w-sm mx-auto leading-relaxed">
          ตรวจสอบคำสั่งซื้อ ยืนยันการชำระเงิน และจัดการการจัดส่งสินค้า
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl p-12 text-center border border-amber-100/50 shadow-sm">
            ...
            <p className="text-brand-600">ยังไม่มีรายการสั่งซื้อ</p>
          </div>
        ) : (
